...
% Works only in the compsoc conferences
...
%  - https://tex.stackexchange.com/a/200330/9075 - for non-comsoc papers
\iffalse
  \IEEEoverridecommandlockouts
...
\begin{lstlisting}[caption={Example Listing}, label=L1, language=Java, float]
public class Hello {
